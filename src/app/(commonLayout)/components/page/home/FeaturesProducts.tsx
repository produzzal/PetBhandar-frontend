    ...
    <div className="py-16 relative">
      <div className="container mx-auto px-0 sm:px-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-3 md:gap-6">
          {featuresProducts.slice(0, 8).map((product: TProduct) => {
            ...
            return (
              <div
                key={product._id}
                className="product-card bg-white w-full p-2 md:p-6 rounded-2xl shadow-lg hover:shadow-neutral-400 transition-all duration-300 flex flex-col justify-between h-full cursor-pointer"
              >
